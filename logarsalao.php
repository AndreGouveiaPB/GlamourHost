...
$cep = $_POST['cep'];
$uf = $_POST['uf'];
$con = mysql_connect("localhost", "root", "gouveia01091910");
...
if ($email_salao and $senha_salao == "" ||$login_salao == null and $email_salao == null and $senha_salao == null) {
    echo"<script language='javascript' type='text/javascript'>alert('Os campos Login, Email e Senha devem ser preenchidos');window.location.href='cadastrarsalao.php';</script>";
} else {
    if ($logarray == $email_salao) {
        echo"<script language='javascript' type='text/javascript'>alert('Esse email já existe');window.location.href='cadastrarsalao.php';</script>";
        die();
    } else {
